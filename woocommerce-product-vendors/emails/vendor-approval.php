...
<p><?php esc_html_e( 'Please use the link below login to the site. Before you can start adding your services you will need to select and pay for one of our membership options. Any problems please get in touch', 'woocommerce-product-vendors' ); ?></p>
